...
def download_preview_bundle(repo, run_id, artifact_name, token):
    ...
    # GitHub artifact ZIP downloads are finicky about headers
    # Solution: Use requests.get with ONLY Authorization header (no Accept header)
    # This avoids the 415 Unsupported Media Type error
