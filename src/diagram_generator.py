...
def wrap(content, title, subtitle, color, date_str):
  ...
  {content}
  <!-- footer -->
  <rect x="0" y="548" width="900" height="32" fill="{BG2}"/>
  <line x1="0" y1="548" x2="900" y2="548" stroke="{BORDER2}" stroke-width="1"/>
  <text x="20" y="568" fill="{TEXT_LITE}" font-size="9" font-family="Arial,sans-serif">{x(date_str)} · Generated by AI</text>
  <rect x="620" y="554" width="265" height="18" rx="9" fill="{color}30" stroke="{color}" stroke-width="1.2"/>
  <text x="752" y="567" text-anchor="middle" fill="{color}" font-size="10" font-weight="700" font-family="Arial,sans-serif" letter-spacing="0.8">AI * (c) Komal Batra</text>
</svg>'''
